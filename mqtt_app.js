...
client.on('message', function (topic, message) {
    ...
    let checkflag4;
    connection.query("SELECT `value` FROM Glucose where username ='Patient1' ORDER BY dt DESC LIMIT 1", function (err, rows) {
        if (err) {
            console.log("Error getting previous Oxidation value ", err);
        }
        else {
            ...
            if (checkflag4 == false) {
                ...
                var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
                if (splits[3] == 0) {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Normal","' + splits[3] + '","' + "Patient1" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Normal Glucose data for Patient 1 inserted successfully");
                        }
                    })
                }
                else {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Abnormal","' + splits[3] + '","' + "Patient1" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Abormal Glucose data for Patient 1 inserted successfully");
                        }
                    })
                }
            }
...
client2.on('message', function (topic, message) {
    ...
    let checkflag4;
    connection.query("SELECT `value` FROM Glucose where username ='Patient2' ORDER BY dt DESC LIMIT 1", function (err, rows) {
        if (err) {
            console.log("Error getting previous Oxidation value ", err);
        }
        else {
            ...
            if (checkflag4 == false) {
                ...
                var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
                if (splits[3] == 0) {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Normal","' + splits[3] + '","' + "Patient2" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Normal Glucose data for Patient 2 inserted successfully");
                        }
                    })
                }
                else {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Abnormal","' + splits[3] + '","' + "Patient2" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Abormal Glucose data for Patient 2 inserted successfully");
                        }
                    })
                }
            }
...
client3.on('message', function (topic, message) {
    ...
    let checkflag4;
    connection.query("SELECT `value` FROM Glucose where username ='Patient3' ORDER BY dt DESC LIMIT 1", function (err, rows) {
        if (err) {
            console.log("Error getting previous Oxidation value ", err);
        }
        else {
            ...
            if (checkflag4 == false) {
                ...
                var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
                if (splits[3] == 0) {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Normal","' + splits[3] + '","' + "Patient3" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Normal Glucose data for Patient 3 inserted successfully");
                        }
                    })
                }
                else {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Abnormal","' + splits[3] + '","' + "Patient3" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Abormal Glucose data for Patient 3 inserted successfully");
                        }
                    })
                }
            }
...
client4.on('message', function (topic, message) {
    ...
    let checkflag4;
    connection.query("SELECT `value` FROM Glucose where username ='Patient4' ORDER BY dt DESC LIMIT 1", function (err, rows) {
        if (err) {
            console.log("Error getting previous Oxidation value ", err);
        }
        else {
            ...
            if (checkflag4 == false) {
                ...
                var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
                if (splits[3] == 0) {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Normal","' + splits[3] + '","' + "Patient4" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Normal Glucose data for Patient 4 inserted successfully");
                        }
                    })
                }
                else {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Abnormal","' + splits[3] + '","' + "Patient4" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Abormal Glucose data for Patient 4 inserted successfully");
                        }
                    })
                }
            }
...
client5.on('message', function (topic, message) {
    ...
    let checkflag4;
    connection.query("SELECT `value` FROM Glucose where username ='Patient5' ORDER BY dt DESC LIMIT 1", function (err, rows) {
        if (err) {
            console.log("Error getting previous Oxidation value ", err);
        }
        else {
            ...
            if (checkflag4 == false) {
                ...
                var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
                if (splits[3] == 0) {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Normal","' + splits[3] + '","' + "Patient5" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Normal Glucose data for Patient 5 inserted successfully");
                        }
                    })
                }
                else {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Abnormal","' + splits[3] + '","' + "Patient5" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Abormal Glucose data for Patient 5 inserted successfully");
                        }
                    })
                }
            }
...
client6.on('message', function (topic, message) {
    ...
    let checkflag4;
    connection.query("SELECT `value` FROM Glucose where username ='Patient6' ORDER BY dt DESC LIMIT 1", function (err, rows) {
        if (err) {
            console.log("Error getting previous Oxidation value ", err);
        }
        else {
            ...
            if (checkflag4 == false) {
                ...
                var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
                if (splits[3] == 0) {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Normal","' + splits[3] + '","' + "Patient6" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Normal Glucose data for Patient 6 inserted successfully");
                        }
                    })
                }
                else {
                    connection.query('INSERT INTO `Glucose`( `level`,`value`,`username`,`sensors_data_date`,`sensors_data_time`) VALUES ("Abnormal","' + splits[3] + '","' + "Patient6" + '","' + date + '","' + time + '")', function (err) {
                        if (err) {
                            console.log("Error inserting Glucose Level ", err);
                        }
                        else {
                            console.log("Abormal Glucose data for Patient 6 inserted successfully");
                        }
                    })
                }
            }
