...
app.get('/Glucose_rate_value1',function(req,res){
	connection.query("SELECT * FROM Glucose where username ='Patient1' ORDER BY dt DESC LIMIT 1", function(err, rows){
		if(!err){
			res.json(rows);
		}
	});
...
app.get('/Glucosegraph',function(req,res){
	var end = moment().endOf('month').format('YYYY-MM-DD');
	var start = moment().startOf('month').format('YYYY-MM-DD');
		connection.query("SELECT value as Glucose,dt FROM Glucose where username ='Patient1' order by dt desc", function(err, rows){
			if(!err){
				res.json(rows);
			}
		});
...
app.get('/Glucose_rate_value2',function(req,res){
	connection.query("SELECT * FROM Glucose where username ='Patient2' ORDER BY dt DESC LIMIT 1", function(err, rows){
		if(!err){
			res.json(rows);
		}
	});
...
app.get('/Glucosegraph2',function(req,res){
	var end = moment().endOf('month').format('YYYY-MM-DD');
	var start = moment().startOf('month').format('YYYY-MM-DD');
		connection.query("SELECT value as Glucose,dt FROM Glucose where username ='Patient2' order by dt DESC", function(err, rows){
			if(!err){
				res.json(rows);
			}
		});
...
app.get('/Glucose_rate_value3',function(req,res){
	connection.query("SELECT * FROM Glucose where username ='Patient3' ORDER BY dt DESC LIMIT 1", function(err, rows){
		if(!err){
			res.json(rows);
		}
	});
...
app.get('/Glucosegraph3',function(req,res){
	var end = moment().endOf('month').format('YYYY-MM-DD');
	var start = moment().startOf('month').format('YYYY-MM-DD');
		connection.query("SELECT value as Glucose,dt FROM Glucose where username ='Patient3' order by dt DESC", function(err, rows){
			if(!err){
				res.json(rows);
			}
		});
...
app.get('/Glucose_rate_value4',function(req,res){
	connection.query("SELECT * FROM Glucose where username ='Patient4' ORDER BY dt DESC LIMIT 1", function(err, rows){
		if(!err){
			res.json(rows);
		}
	});
...
app.get('/Glucosegraph4',function(req,res){
	var end = moment().endOf('month').format('YYYY-MM-DD');
	var start = moment().startOf('month').format('YYYY-MM-DD');
		connection.query("SELECT value as Glucose,dt FROM Glucose where username ='Patient4' order by dt DESC", function(err, rows){
			if(!err){
				res.json(rows);
			}
		});
...
app.get('/Glucose_rate_value5',function(req,res){
	connection.query("SELECT * FROM Glucose where username ='Patient5' ORDER BY dt DESC LIMIT 1", function(err, rows){
		if(!err){
			res.json(rows);
		}
	});
...
app.get('/Glucosegraph5',function(req,res){
	var end = moment().endOf('month').format('YYYY-MM-DD');
	var start = moment().startOf('month').format('YYYY-MM-DD');
		connection.query("SELECT value as Glucose,dt FROM Glucose where username ='Patient5' order by dt DESC", function(err, rows){
			if(!err){
				res.json(rows);
			}
		});
...
app.get('/Glucose_rate_value6',function(req,res){
	connection.query("SELECT * FROM Glucose where username ='Patient6' ORDER BY dt DESC LIMIT 1", function(err, rows){
		if(!err){
			res.json(rows);
		}
	});
...
app.get('/Glucosegraph6',function(req,res){
	var end = moment().endOf('month').format('YYYY-MM-DD');
	var start = moment().startOf('month').format('YYYY-MM-DD');
		connection.query("SELECT value as Glucose,dt FROM Glucose where username ='Patient6' order by dt DESC", function(err, rows){
			if(!err){
				res.json(rows);
			}
		});
